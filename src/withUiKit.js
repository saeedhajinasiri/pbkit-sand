...
const {primary} = require('./colors/primary');
...
const {grey} = require('./colors/grey');
const {purple} = require('./colors/purple');

const withUiKit = (tailwindConfig) => {
  return {
    content: [
      "./node_modules/@pezeshk-book/ui-kit/**/*",
      "./node_modules/@pezeshk-book/modules/**/*",
    ...
    theme: {
      ...
      minHeight: {
        ...
        '80': '20rem',
        '96': '24rem',
        ...tailwindConfig.theme.minHeight,
      },
