      ...
      <div className="relative flex items-center cursor-pointer">
        <input
          ...
          className={classNames(
            'peer relative appearance-none rounded-sm sm:rounded cursor-pointer transition-all',
            disabled ? 'border border-control-light checked:bg-control-light' : COLORS[color],
            SIZES[size],
            className,
          )}
          {...rest}
