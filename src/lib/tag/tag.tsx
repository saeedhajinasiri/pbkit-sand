...
export const Tag = ({id, title = "title", disabled, size = "medium", rounded = "medium", color = "primary", variant, onChange}: TagProps) => {
  ...
  return (
    <Div className={classNames('w-fit flex items-center gap-x-1 px-2 py-1',
      ...
      <Text
        className={classNames(TITLE_SIZE[size], disabled ? 'grey.400' : 'grey.800')}>
        {title}
      </Text>
      ...
      <Div className={classNames('relative flex items-center',
        ...
        <svg
          ...
          <path d="M8.00001 14.6666C11.6667 14.6666 14.6667 11.6666 14.6667 7.99998C14.6667 4.33331 11.6667 1.33331 8.00001 1.33331C4.33334 1.33331 1.33334 4.33331 1.33334 7.99998C1.33334 11.6666 4.33334 14.6666 8.00001 14.6666Z"
                stroke="#5C5F66"
                strokeLinecap="round"
                strokeLinejoin="round"/>
          <path d="M6.11334 9.88668L9.88668 6.11334"
                stroke="#5C5F66" strokeLinecap="round"
                strokeLinejoin="round"
          />
          <path d="M9.88668 9.88668L6.11334 6.11334"
                stroke="#5C5F66" strokeLinecap="round"
                strokeLinejoin="round"
          />
        </svg>
